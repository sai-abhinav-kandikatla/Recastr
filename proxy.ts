...
function withSecurityHeaders(response: NextResponse) {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com https://va.vercel-scripts.com https://checkout.razorpay.com",
      "style-src 'self' 'unsafe-inline'",
      "img-src 'self' data: blob: https:",
      "font-src 'self' data:",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://challenges.cloudflare.com https://vitals.vercel-analytics.com https://app.posthog.com https://*.posthog.com https://api.razorpay.com https://lumberjack.razorpay.com",
