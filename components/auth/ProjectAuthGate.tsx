  ...
  return (
    <section className="mx-auto flex min-h-[calc(100vh-160px)] max-w-3xl items-center justify-center px-4 py-12">
      <div className="w-full rounded-3xl border border-[var(--app-line)] bg-[var(--app-surface)] p-8 text-center">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--violet)] text-black">
        ...
        <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
          <Button className="rounded-full bg-[var(--violet)] text-black hover:bg-[var(--violet-hover)]" onClick={() => setOpen(true)}>
