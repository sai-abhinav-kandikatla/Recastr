...
export const generateSchema = z.object({
  ...
  platform: z
    .enum(["TWITTER", "LINKEDIN", "INSTAGRAM", "FACEBOOK", "THREADS", "CAROUSEL", "COMMUNITY", "STORY", "HOOKS", "CTA"])
    .optional(),
  tone: z.enum([
    "Professional",
    "Casual",
...
export const scheduleSchema = z.object({
  ...
  platform: z.enum(["TWITTER", "LINKEDIN", "INSTAGRAM", "FACEBOOK", "THREADS", "CAROUSEL", "COMMUNITY", "STORY", "HOOKS", "CTA"]),
